...
ISTQB 2005 01.07.2005 Certified Tester Foundation Level Syllabus v1.
ASQF V2.2 07.2003 ASQF Syllabus Foundation Level Version v2.2 “Lehrplan Grundlagen
des Software-testens“
ISEB V2.0 25.02.1999 ISEB Software Testing Foundation Syllabus v2.
```
...
- v4.0.1 Page 5 of 78 2024 -09- Foundation Level
...
- v4.0.1 Page 6 of 78 2024 -09- Foundation Level
...
- v4.0.1 Page 7 of 78 2024 -09- Foundation Level
...
automotive or gaming). Please visit [http://www.istqb.org](http://www.istqb.org) for the latest information on ISTQB ́s Certified Tester
Scheme.
...
to relevant and current information, the ISTQB working groups have created links on the [http://www.istqb.org](http://www.istqb.org)
...
Brykczynski, B. (1999) “A survey of software inspection checklists,” _ACM SIGSOFT Software Engineering
Notes, 24(1), pp. 82- 89_
...
Enders, A. (1975) “An Analysis of Errors and Their Causes in System Programs,” _IEEE Transactions on
Software Engineering 1(2), pp. 140-149_

Manna, Z., Waldinger, R. (1978) “The logic of computer programming,” _IEEE Transactions on Software
Engineering 4(3), pp. 199-229_
...
Nielsen, J. (1994) “Enhancing the explanatory power of usability heuristics,” _Proceedings of the SIGCHI
Conference on Human Factors in Computing Systems: Celebrating Interdependence, ACM Press, pp.
152 – 158_

Salman. I. (2016) “Cognitive biases in software quality and testing,” _Proceedings of the 38th International
Conference on Software Engineering Companion (ICSE '16), ACM, pp. 823-826._

Wake, B. (2003) “INVEST in Good Stories, and SMART Tasks _,”_ https://xp123.com/articles/invest-in-good-
...
Foundation Level
```
v4.0.1 Page 65 of 78 202 4-09- 15
...
```
```
FL-BO10 FL-BO11 FL-BO12 FL-BO13 FL-BO14
```
```
...
```
```
v4.0.1 Page 66 of 78 202 4-09- 15
```
Chapter/
section/
subsection
...
```
```
v4.0.1 Page 67 of 78 202 4-09- 15
```
Chapter/
section/
subsection
...
```
```
v4.0.1 Page 68 of 78 202 4-09- 15
```
Chapter/
section/
subsection
...
3.2.3
Recall which responsibilities are assigned to the principal roles when performing
reviews
...
```
```
v4.0.1 Page 69 of 78 202 4-09- 15
```
Chapter/
section/
subsection
...
```
4.1.1
Distinguish black-box test techniques, white-box test techniques and experience-
...
```
```
v4.0.1 Page 70 of 78 202 4-09- 15
```
Chapter/
section/
subsection
...
```
```
v4.0.1 Page 71 of 78 202 4-09- 15
```
Chapter/
section/
subsection
...
Foundation Level
```
v4.0.1 Page 72 of 78 202 4- 09-15
...
Foundation Level
```
v4.0.1 Page 73 of 78 202 4- 09-15
...
Foundation Level
```
v4.0.1 Page 74 of 78 202 4- 09-15
...
At the time the syllabus was written ( 202 2-2023) more than one million people in more than 100 countries
...
Foundation Level
```
v4.0.1 Page 75 of 78 202 4- 09-15
...
Foundation Level
```
v4.0.1 Page 76 of 78 202 4- 09-15
...
Foundation Level
```
v4.0.1 Page 77 of 78 202 4- 09-15
...
Foundation Level
```
v4.0.1 Page 78 of 78 202 4- 09-15
